...
/*
  ...
  of the content.
  It takes as parameter the underlying base cache that is wrapped.
  It returns a cache object with read and write methods.
    read: returns either undefined if cache miss or verification fail, or the underlying cache value read
    write: always delegates to the underlying cache write
 */
